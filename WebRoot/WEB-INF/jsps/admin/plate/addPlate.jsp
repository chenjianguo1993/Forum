...
<script type="text/javascript">
	//ueditor调用
	//1.先删除
	 UE.delEditor('plate_container');
	//2.再加载
		var ue = UE.getEditor('plate_container', {
...
function addplate(){
	...
	//解码decodeURI(test1);
	$.post("/Forum/servlet/AddPlateServlet?encode_content="+encode_content+"&fatherPlate="+fatherPlate, $("#add_plate_form").serialize(),// 这是form的
			// id
			function(msg) {
	...
	<form id="add_plate_form" method="post" onsubmit="return addplate()">
		<script id="plate_container" name="content" type="text/plain">
		请输入版块名称
    </script>
    <div id="father_plate">
